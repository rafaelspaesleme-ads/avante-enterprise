 ...
 */
public class rplorcamentoTelaCadUsuario extends javax.swing.JFrame {

    /**
     * Creates new form rplorcamentoTelaCadUsuario
     */
    public rplorcamentoTelaCadUsuario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jList_funcionario = new javax.swing.JList();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jButton_salvar, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                ...
                .addGap(18, 18, 18)
                .addComponent(jButton_listar, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton_imprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jList_funcionario.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jList_funcionario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jList_funcionarioMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jList_funcionario);
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jText_nomeUsuario))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jText_matriculaFuncionario)
                            .addComponent(jCbx_nivel, 0, 193, Short.MAX_VALUE)
    ...
    private void jList_funcionarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList_funcionarioMouseClicked

        ExibirInfoFuncionarios();

// TODO add your handling code here:
    }//GEN-LAST:event_jList_funcionarioMouseClicked
...
// TODO add your handling code here:
            ...
            Logger.getLogger(rplorcamentoTelaCadUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jButton_salvarActionPerformed

    public void SalvarUsuarios() throws ClassNotFoundException {
...
// TODO add your handling code here:
    ...
    public void ExibirInfoFuncionarios() {
        ...
        String buscarNome = (String) jList_funcionario.getSelectedValue();
        ...
        try {
            ...
            if (!buscarNome.equals("")) {
                ...
                while (rs.next()) {
                    ...
                    jText_nomeFuncionario.setText(rs.getString("nome"));
                    jText_matriculaFuncionario.setText(rs.getString("id"));
                }
...
//          cbx_id_pes_usuario.removeAllItems();
            ...
            jList_funcionario.removeAll();

            ArrayList<String> lista = new ArrayList<String>();

            while (rs.next()) {

                if (rs.getString("acesso_sistema").equals("1")) {
            ...
            jList_funcionario.setModel(model);
            while (it.hasNext()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rplorcamentoTelaCadUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rplorcamentoTelaCadUsuario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList jList_funcionario;
